...
from free_claude_code.providers.nvidia_nim.keys import parse_nvidia_nim_api_keys
...
def credential_configured(descriptor: ProviderDescriptor, credential: str) -> bool:
    """Return whether a credential string is usable for this provider."""
...
def require_provider_credential(
    ...
    if descriptor.credential_env is None:
        return
    if credential_configured(descriptor, credential):
        return
